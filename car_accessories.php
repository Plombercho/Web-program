...
if (isset($_GET['search'])) {
    ...
    if (!empty($search_term)) {
        $search_query = "SELECT * FROM items WHERE (name LIKE ? OR type LIKE ?) AND type = 'car_accessory'";
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav mr-auto">
                        ...
                        if (isset($_SESSION['user_id'])) {
                            ...
                            <li class="nav-item active"><a href="car_accessories.php" class="nav-link">Аксесоари</a></li>
